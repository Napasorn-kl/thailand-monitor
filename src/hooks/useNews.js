...
const NEWS_CATEGORY_KEYWORDS = {
  ...
  food:   ['อาหาร','food','beverage','เครื่องดื่ม','restaurant','cpf','อุตสาหกรรมอาหาร','ข้าวสาร','ข้าวเปลือก','ราคาข้าว','ชาวนา','น้ำตาลทราย','เนื้อสัตว์','dairy','snack','fnb','f&b','ประมง','seafood','กุ้งแช่แข็ง','ทูน่า','tuna','thai union','betagro','oishi','singha','chang','เบียร์','นมโค','สุรา','เกษตรกร','ราคาพืชผล','ยางพาราราคา','มันสำปะหลัง','อ้อย','ปาล์มน้ำมัน','ปศุสัตว์','ราคาสุกร','ราคาไก่','ผักผลไม้ราคา','เบียร์ช้าง','ไทยเบฟ','เสริมสุข','น้ำดื่มคริสตัล','แม่โขง','เครื่องดื่มแอลกอฮอล์','เครื่องดื่มไม่มีแอลกอฮอล์','วิสกี้','เหล้าขาว','เหล้าสี','เครื่องดื่มชูกำลัง','น้ำอัดลม','น้ำดื่ม','ชาพร้อมดื่ม','เครื่องดื่มสุขภาพ','Functional Drink','Chang Beer','Archa Beer','Mekhong','SangSom','Hong Thong','Blend 285','Regency','Ichitan','est Cola','Crystal Drinking Water'],
